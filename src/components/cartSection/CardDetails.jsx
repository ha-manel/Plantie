...
const CardDetails = () => {
  ...
  return (
    <div className="w-1/3 h-fit mt-4 py-10 px-8 ml-6 bg-gradient-to-t from-secondary-400 to-secondary-300 text-gray-300 rounded-2xl font-nunito">
        ...
        <div className="w-full flex justify-around mb-6">
          <div>
            <label htmlFor="visa" className="flex items-center">
              <span>Visa</span>
              <input type="radio" id="visa" className="ml-2" name="cardType" />
            </label>
          </div>
          <div>
